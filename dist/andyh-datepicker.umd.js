(function (global, factory) {
    ...
    return _c(
      ...
      [
        ...
        _c(
          "div",
          {
            staticClass: "button text-center arrow-button",
            on: {
        ...
        _c(
          "div",
          {
            staticClass: "button text-center date-title-small",
            on: {
              click: function($event) {
                return _vm.setToday()
              }
  ...
  function install(Vue) {
      ...
      Vue.component("AndyHDateicker", __vue_component__);
  }
